...
export default function LoginPage({ onLogin, lang, setLang, t }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const user = selectedRole === 'citizen' ? MOCK_USERS.citizen : (selectedRole === 'contractor' ? MOCK_USERS.contractor : MOCK_USERS.officer);
    onLogin(user);
  };

  const handleQuickDemo = (role) => {
    const user = role === 'citizen' ? MOCK_USERS.citizen : (role === 'contractor' ? MOCK_USERS.contractor : MOCK_USERS.officer);
    onLogin(user);
  };
